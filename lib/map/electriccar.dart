...
class ElectricCar extends StatefulWidget {
  ...
  const ElectricCar({Key? key, required this.long, required this.lat}) : super(key: key);
...
class _ElectricCarState extends State<ElectricCar> {
  Future<List>? elecCoordData;

  @override
  void initState(){
    super.initState();
    elecCoordData = getElecinfo(widget.lat, widget.long);
  }
...
class ELEC {
  ...
  factory ELEC.fromJson(Map<dynamic, dynamic> json) {
    return ELEC(
      type: json['type'],
      name: json['name'],
